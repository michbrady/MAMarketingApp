 ...
 * Creates test database and runs all schema scripts
 */
 ...
 */
async function seedTestData(pool: sql.ConnectionPool) {
  // Markets
 ...
 */
async function verifyDatabase(pool: sql.ConnectionPool) {
